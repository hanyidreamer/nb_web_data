...
public class CheckListUtil {
	public static void info(BigLog bigLog){
		ActionLogHelper.businessLog(bigLog.getTraceId(), true, bigLog.getServiceName(),
				bigLog.getAppName(),null, StringUtils.isEmpty(bigLog.getElapsedTime())?0:Integer.valueOf(bigLog.getElapsedTime()), 0, null, bigLog.getResponseBody(),bigLog.getRequestBody());
	}
