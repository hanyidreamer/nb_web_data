...
@XmlSeeAlso({
    SetB2BSellChannelResponse2 .class,
    GetHotelRoomPriceResponse2 .class,
    GetAllPriceByHotelIdResponse2 .class,
    GetRatePlanBaseInfoResponse2 .class,
    GetRatePlanBaseListResponse2 .class
})
