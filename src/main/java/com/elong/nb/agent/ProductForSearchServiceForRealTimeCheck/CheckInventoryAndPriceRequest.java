...
/**
 * <p>CheckInventoryAndPriceRequest complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CheckInventoryAndPriceRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CheckInventoryAndPriceRequest", namespace = "http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Entities.Request", propOrder = {
    "arriveDate",
    "bookingTime",
    "currencyCode",
    "dynamicId",
...
public class CheckInventoryAndPriceRequest
    extends ProductRequestBase
{
    ...
    @XmlElement(name = "DynamicId", nillable = true)
