...
/**
 * <p>ResourceInvAndInstantConfirmState complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ResourceInvAndInstantConfirmState"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="IsInstantConfirm" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
...
@XmlType(name = "ResourceInvAndInstantConfirmState", namespace = "http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Entities.Model.Inventory", propOrder = {
    "availableAmount",
    "availableTime",
    "beginDate",
    "beginTime",
...
public class ResourceInvAndInstantConfirmState {
    ...
    @XmlElement(name = "IC_BeginTime", nillable = true)
    protected String icBeginTime;
    @XmlElement(name = "IC_EndTime", nillable = true)
