...
/**
 * <p>HotelGeneralAmenities complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="HotelGeneralAmenities"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "HotelGeneralAmenities", namespace = "http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Contract", propOrder = {
    "amenitySimpleList",
    "overview"
})
public class HotelGeneralAmenities {
