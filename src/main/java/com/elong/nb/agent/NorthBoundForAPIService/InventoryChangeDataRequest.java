...
/**
 * <p>InventoryChangeDataRequest complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="InventoryChangeDataRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "InventoryChangeDataRequest", namespace = "http://schemas.datacontract.org/2004/07/Com.Elong.BusinessService.Domain.Hotel.Message", propOrder = {
    "cityIDs",
    "hotelIDs",
    "lastChgId",
    "lastChgTime",
...
public class InventoryChangeDataRequest
    extends Request
{
