...
/**
 * <p>HotelConferenceAmenities complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="HotelConferenceAmenities"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "HotelConferenceAmenities", namespace = "http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Contract", propOrder = {
    "amenityList",
    "overview"
})
public class HotelConferenceAmenities {
