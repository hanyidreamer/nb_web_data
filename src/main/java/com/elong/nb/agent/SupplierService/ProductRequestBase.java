...
@XmlSeeAlso({
    InsertNameStrategyInfoRequest.class,
    GetNameStrategyInfoRequest.class,
    DeleteNameStrategyInfoRequest.class,
    IsQunarSupplierRequest.class,
    GetSupplierInfoBySupplierIDRequest.class,
    InsertSupplierInfoRequest.class,
    GetSupplierListByParamsRequest.class,
    UpdateSupplierStatusRequest.class,
    UpdateSupplierInfoRequest.class
})
