...
/**
 * <p>EditRoomStatus4EBRequest complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="EditRoomStatus4EBRequest"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="IgnoreInventorySummary" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="InventoryType" type="{http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Entities.Enums.Inventory}ArrayOfInventoryType" minOccurs="0"/&gt;
...
@XmlType(name = "EditRoomStatus4EBRequest", namespace = "http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Entities.Request.Product4Partners", propOrder = {
    "arriveDate",
    "closeRoomType",
    "hotelID",
    "ignoreInventorySummary",
    "inventoryType",
    "leaveDate",
    "operateComments",
    "operateIP",
...
public class EditRoomStatus4EBRequest {
    ...
    @XmlElement(name = "IgnoreInventorySummary")
    protected Boolean ignoreInventorySummary;
    @XmlElement(name = "InventoryType", nillable = true)
    protected ArrayOfInventoryType inventoryType;
     ...
     *     
     */
    public void setIgnoreInventorySummary(Boolean value) {
        this.ignoreInventorySummary = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link ArrayOfInventoryType }
     *     
     */
    public ArrayOfInventoryType getInventoryType() {
     ...
     *     
     */
    public void setInventoryType(ArrayOfInventoryType value) {
