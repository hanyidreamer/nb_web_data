...
@XmlSeeAlso({
    GetClosedBedTypeInfoRequest.class,
    GetSupplierInfoRequest.class,
    BatchEditInvAmountAndStatusForEBookingRequest.class,
    GetRoomTypeByShotelIdRequest.class,
    GetInventoryChangeDetailRequest.class,
    GetInventoryChangeListRequest.class,
    GetInventoryChangeMinIDRequest.class,
    GetInvChangeAndInstantConfirmRequest.class,
    FreeSaleRequest.class,
    IsDCRoomBackupRequest.class,
    GetHotelInventoryDetail4PartnersRequest.class
})
