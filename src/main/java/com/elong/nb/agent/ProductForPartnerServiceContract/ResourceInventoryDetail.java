...
/**
 * <p>ResourceInventoryDetail complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ResourceInventoryDetail"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="InventoryStatus" type="{http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Entities.Enums.Inventory}InventoryStatus" minOccurs="0"/&gt;
...
@XmlType(name = "ResourceInventoryDetail", namespace = "http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Entities.Model.Product4Partners", propOrder = {
    "amount",
    "availableAmount",
    "availableDate",
    "beginTime",
...
public class ResourceInventoryDetail {
     ...
     *     
     */
    public void setInventoryStatus(InventoryStatus value) {
