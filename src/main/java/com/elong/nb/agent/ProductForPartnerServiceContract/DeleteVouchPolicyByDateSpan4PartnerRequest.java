...
/**
 * <p>DeleteVouchPolicyByDateSpan4PartnerRequest complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DeleteVouchPolicyByDateSpan4PartnerRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DeleteVouchPolicyByDateSpan4PartnerRequest", namespace = "http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Entities.Request", propOrder = {
    "endDate4Delete",
    "hotelId",
    "operator",
    "operatorIp",
...
public class DeleteVouchPolicyByDateSpan4PartnerRequest {
