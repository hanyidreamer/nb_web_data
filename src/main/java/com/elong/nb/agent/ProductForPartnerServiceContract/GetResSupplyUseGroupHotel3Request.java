...
/**
 * <p>GetResSupplyUseGroupHotel3Request complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetResSupplyUseGroupHotel3Request"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GetResSupplyUseGroupHotel3Request", namespace = "http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Entities.Request.Inventory", propOrder = {
    "endDate",
    "hotelID",
    "roomTypeIDs",
    "startDate"
})
public class GetResSupplyUseGroupHotel3Request {
