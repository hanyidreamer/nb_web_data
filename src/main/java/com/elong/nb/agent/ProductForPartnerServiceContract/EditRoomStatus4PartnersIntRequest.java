...
/**
 * <p>EditRoomStatus4PartnersIntRequest complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="EditRoomStatus4PartnersIntRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "EditRoomStatus4PartnersIntRequest", namespace = "http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Entities.Request", propOrder = {
    "arriveDate",
    "closeRoomType",
    "hotelID",
    "inventoryType",
...
public class EditRoomStatus4PartnersIntRequest {
