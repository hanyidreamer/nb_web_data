...
/**
 * <p>SaveRoomOverSaleInventory4PartnerResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SaveRoomOverSaleInventory4PartnerResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SaveRoomOverSaleInventory4PartnerResponse", namespace = "http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Entities.Response", propOrder = {
    "affectedDateIntervals"
})
public class SaveRoomOverSaleInventory4PartnerResponse
