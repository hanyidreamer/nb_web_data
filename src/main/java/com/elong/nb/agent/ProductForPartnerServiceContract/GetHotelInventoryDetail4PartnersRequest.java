...
/**
 * <p>GetHotelInventoryDetail4PartnersRequest complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetHotelInventoryDetail4PartnersRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GetHotelInventoryDetail4PartnersRequest", namespace = "http://schemas.datacontract.org/2004/07/com.eLong.Hotel.Product.Entities.Request.Product4Partners", propOrder = {
    "endDate",
    "hotelID",
    "roomTypeIdList",
    "startDate"
...
@XmlSeeAlso({
    GetHotelInventoryDetail4PartnersIntRequest.class
})
public class GetHotelInventoryDetail4PartnersRequest
